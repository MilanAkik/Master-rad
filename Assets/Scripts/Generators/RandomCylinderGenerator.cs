...
namespace Assets.Scripts.Generators
{
    ...
    public class RandomCylinderGenerator : CylinderGenerator
    {
        ...
        private Vector2 _rRange = new Vector2(0.01f, 1f);
        private Vector2 _hRange = new Vector2(0.01f, 1f);
        ...
        public override Matrix4x4[] getCylinderMatrices(GeneratorParameters parameters)
        {
            ...
            {
                var x = Mathf.Lerp(areaMin.x, areaMax.x,Random.Range(_xRange.x, _xRange.y));
                var y = Mathf.Lerp(areaMin.y, areaMax.y, Random.Range(_yRange.x, _yRange.y));
                var z = Mathf.Lerp(areaMin.z, areaMax.z, Random.Range(_zRange.x, _zRange.y));
